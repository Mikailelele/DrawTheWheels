...
public partial class @StarterAssetsInput: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""CanLook"",
                    ""type"": ""PassThrough"",
                    ""id"": ""ccf9d324-5d29-44f1-b2ec-c1d5c4a31b78"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""6e1f4af7-d46a-4828-bc8e-9921203a83d0"",
    ...
    ""controlSchemes"": [
        ...
        m_Player_CanLook = m_Player.FindAction("CanLook", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_Player_CanLook;
    public struct PlayerActions
    {
        ...
        public InputAction @CanLook => m_Wrapper.m_Player_CanLook;
        ...
        public void AddCallbacks(IPlayerActions instance)
        {
            ...
            @CanLook.started += instance.OnCanLook;
            @CanLook.performed += instance.OnCanLook;
            @CanLook.canceled += instance.OnCanLook;
        }
    ...
    public interface IPlayerActions
    {
        ...
        void OnCanLook(InputAction.CallbackContext context);
    }
}
